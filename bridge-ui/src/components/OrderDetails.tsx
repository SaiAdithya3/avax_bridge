...
//   console.log(isCompleted)
  ...
  // Defensive: check for required nested properties before rendering
          ...
          <div className="space-y-3">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {sourceSwap?.amount ? formatAmount(sourceSwap.amount) : '--'} {sourceSwap?.asset ? getAssetSymbol(sourceSwap.asset) : ''}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">To:</span>
              <span className="font-medium">
                {destinationSwap?.amount ? formatAmount(destinationSwap.amount) : '--'} {destinationSwap?.asset ? getAssetSymbol(destinationSwap.asset) : ''}
              </span>
            </div>
            <div className="flex justify-between">
