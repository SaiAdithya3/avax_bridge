...
import { type BitcoinWalletConfig, type IBitcoinWallet } from './wallet.interface';
...
export abstract class AbstractBitcoinWallet implements IBitcoinWallet {
   ...
   *
   */
  async newSwap(swapConfig: AtomicSwapConfig): Promise<BitcoinHTLC> {
