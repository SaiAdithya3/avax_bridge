...
import { Urgency, type IBitcoinProvider } from '../provider/provider.interface';
...
import type { BitcoinWalletConfig } from './wallet.interface';

function reversify(val: string): Buffer {
